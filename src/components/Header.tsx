      ...
      <div className="flex items-center gap-3">
        ...
        {activeView === 'dashboard' ? (
          <button
            ...
            className="flex items-center gap-1.5 bg-[#2563eb] text-[#ffffff] px-3.5 py-2 rounded-lg text-[14px] font-semibold hover:bg-[#004ac6] transition-colors shadow-xs"
          >
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => onNavigate('dashboard')}
              className="text-[#434655] hover:text-[#004ac6] px-3 py-2 text-[14px] font-medium hidden xs:inline-block"
            >
              View Live Radar
            </button>
            <button
              onClick={() => onNavigate('dashboard')}
              className="bg-[#2563eb] text-[#ffffff] px-4 py-2 rounded-lg text-[14px] font-semibold hover:bg-[#004ac6] transition-colors shadow-xs active:scale-[0.98]"
            >
              Start Free
            </button>
          </div>
